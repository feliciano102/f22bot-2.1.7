...
global.channelLink = "https://chat.whatsapp.com/EnFr47c0mEZ0o95Vp64ksC";
global.ytch = "𝐖𝐒 𝐇𝐚𝐜𝐤𝐞𝐫";

// Import empty channel info to remove "Acessar canal" button
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        // Verificar se o usuário está banido (ignorar verificação para o comando unban)
        if (isBanned(senderId) && !userMessage.startsWith('.unban')) {
            // Responder apenas ocasionalmente para evitar spam
            if (Math.random() < 0.1) {
                await sock.sendMessage(chatId, {
                    text: '❌ Você está banido de usar o bot. Contate um administrador para ser desbanido.',
                    ...channelInfo
                });
            }
            return;
        ...
        /*  // Resposta básica de mensagem em chat privado
          if (!isGroup && (userMessage === 'hi' || userMessage === 'hello' || userMessage === 'bot' || userMessage === 'hlo' || userMessage === 'hey' || userMessage === 'bro' || userMessage === 'oi' || userMessage === 'olá')) {
              await sock.sendMessage(chatId, {
